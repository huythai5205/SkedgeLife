...
class SignUpUserForm extends Component {
    ...
    onSubmit = event => {
        ...
        axios.post('/api/user', newUser).then(user => {
                ...
                <div className="row">
                    <form className="col s12" onSubmit={this.onSubmit}>
                        <div className="input-field col s6">
                            ...
                            <input id="firstName" type="text" onChange={this.change} required />
                        </div>
                        <div className="input-field col s6">
                            <label htmlFor="lastName">*Last Name</label>
                            <input id="lastName" type="text" onChange={this.change} required />
                        </div>
                        <div className="input-field col s6">
                        ...
                        <div className="input-field col s6">
                            ...
                            <input id="password" type="password" onChange={this.change} required />
                        </div>
                        <div>
...
export default connect(null, { addFlashMessage, setCurrentUser })(SignUpUserForm);